...
def dataframe_to_sql_bcpandas(engine, dataframe, table_name, dtype=None, schema="dbo", if_exists='replace', index=False):
    """
    ...
    to_sql(df=dataframe, table_name=table_name, creds=creds, dtype=dtype, schema=schema, if_exists=if_exists, index=index)
